    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String title = request.getParameter("title");
            ...
            List<ResourcesDTO> listupdate = resourcesDAO.updateResources(title, description, content_resources, category, image_link, created_date);
            if(listupdate!=null && !listupdate.isEmpty()){
                request.setAttribute("mess", "You have successfully updated your post! Please return to your directory");
                request.getRequestDispatcher("updateResources.jsp").forward(request, response);
        }else{
                request.setAttribute("mess", "Update failed ! Please update later");
                request.getRequestDispatcher("updateResources.jsp").forward(request, response);
            }
    }
    }
