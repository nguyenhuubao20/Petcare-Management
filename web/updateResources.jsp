    ...
    <body>
        ...
        <div class="add-article-form">
            ...
            <form action="Update">
                ...
                <input type="text" id="title" name="title" placeholder="Enter title" value="">
                <script>document.getElementById("title").value = "${sessionScope.title}";</script><br><br>

                <label for="description"></label>
                <input id="description" type="hidden" name="description" value="${sessionScope.description}">

                <label for="content">Content:</label>
                <textarea id="content" name="content"  placeholder="Enter content"></textarea>
                <script>document.getElementById("content").value = "${sessionScope.content}";</script>
                ...
                <input type="hidden" id="author_name" name="author_name" value="${sessionScope.user.name}"><br><br>
                <input type="hidden" id="author_id" name="author_id" value="${sessionScope.user.user_id}"><br><br>

                <label for="image_link">Image Link:</label>
                <input type="text" id="image_link" name="image_link" placeholder="Enter image link" value="">
                <script>document.getElementById("image_link").value = "${sessionScope.image_link}";</script><br><br>

                <button type="submit" name="action">Update Article</button>
            </form>
                </div>
