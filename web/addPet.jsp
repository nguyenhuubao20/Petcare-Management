...
form[action="PetController"] label {
  display: block;
  margin-bottom: 5px;
  color: #333;
  font-weight: bold;
...
form[action="PetController"] input[type="number"],
form[action="PetController"] input[type="text"] {
  width: 100%;
  padding: 8px;
  border: 1px solid #ccc;
  border-radius: 5px;
...
/* CSS cho liên kết "Go back to User Profile" */
a.goback {
  display: inline-block;
  background-color: #007bff;
  color: #fff;
  ...
  <c:if test="${not empty sessionScope.user.name}">
    ...
    Log out
        ...
        <form action="PetController" method="POST">
            ...
            <input type="number" id="petAge" name="petAge" required><br>
            
            <label for="allergy">Allergy:</label>
            <input type="text" id="allergy" name="allergy" required><br>
            
            <label for="profilePicture">Profile Picture:</label>
            <input type="text" id="profilePicture" name="profilePicture" required><br>

            <input type="hidden" name="user_id" value="${sessionScope.user.user_id}">
            <input type="hidden" name="action" value="add">
            <input name="action" value="Add Pet" type="submit">
        </form>
        
        <br>
        <a class="goback" href="userProfile.jsp">Go back to User Profile</a>
