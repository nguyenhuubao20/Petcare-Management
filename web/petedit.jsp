...
.edit-pet-form input[type="submit"] {
...
.edit-pet-form input[type="submit"]:hover {
  background-color: #0056b3;
    ...
    <body>
        ...
        <h1 class="edit-pet-header">Edit Pet</h1>
<form class="edit-pet-form" action="PetController" method="POST">
    <label for="petName">Pet Name:</label>
    <input type="text" id="petName" name="petName" value="${pet.petName}">
    <br>
    <label for="petAge">Pet Age:</label>
    <input type="number" id="petAge" name="petAge" value="${pet.petAge}">
    <br>
    <label for="allergy">Allergy:</label>
    <input type="text" id="allergy" name="allergy" value="${pet.allergy}">
    <br>
    <label for="profilePicture">Profile Picture:</label>
    <input type="text" id="profilePicture" name="profilePicture" value="${pet.profilePicture}">
    <br>
